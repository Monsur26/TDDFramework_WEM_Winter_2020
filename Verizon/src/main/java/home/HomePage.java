...
public class HomePage extends WebAPI {
    ...
    public void selectDropDownByIndex(WebElement storeStateDD, int i) {
    }
    ...
    public void signInHover(){
        mouseHover(signInHover);}

    public void mouseHover(WebElement signInHover) {
    }
    ...
    public void scrollUpDownByHeight() {
    }
