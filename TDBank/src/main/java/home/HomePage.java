...
public class HomePage extends WebAPI {
    ...
    public void navigationMenuSet() {navigationMenu.click();}
    public void searchButtonSet(String keyword) {searchButton.sendKeys(keyword);}
    public void userAccessSet() {userAccess.click();}
    public void quickServiceSet() {quickService.click();}
    public void serviceMenuSet() {serviceMenu.click();}
    //Test Cases
